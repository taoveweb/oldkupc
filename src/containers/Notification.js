...
class Notification extends React.Component {
  constructor(props) {
    super(props);
    document.title="偶酷通知清理 · 干净、整洁的通知栏";
  ...
  render() {
    return (
      <main className="container landing">
        <div className="alert alert-warning" role="alert">原「豌豆荚通知清理」已更名「偶酷通知清理」，感谢各位用户长期支持！</div>
        <section className="hero row">
          ...
          <div className="col-sm-6">
            ...
            <h1>偶酷通知清理<br/>干净，整洁，你的通知栏本该如此</h1>
            <p className="lead">自动清除广告通知<br/>准确归类不同类型通知<br/>简洁清爽的设计<br/>给你不一样的通知栏</p><p
            className="downloads"><Link to=""
                                     className="btn btn-primary android-download notification">查看详情 »</Link></p><p
            className="lead">
            或到豌豆荚等各 Android 应用商店搜索「偶酷通知清理」即可下载。</p></div>
        </section>
      </main>
    );
  }
